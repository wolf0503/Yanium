    ...
    <section id="how-we-work" className="relative py-12 px-6 md:py-32">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-16 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-4">
          {steps.map((s, i) => (
            <motion.div key={s.num}
              ...
              <p className="mb-1 font-mono text-[11px] tracking-[0.3em] text-gold/60">// {s.num} · {s.label}</p>
              <p className="mb-4 font-serif text-base leading-relaxed text-silver/70">{s.body}</p>
              <div className="border-t border-white/[0.06] pt-3">
                <span className="font-mono text-[11px] tracking-[0.15em] text-silver/35">{s.timeline}</span>
              </div>
        ...
        <motion.div
          ...
          <p className="mb-5 font-mono text-[11px] tracking-[0.3em] text-silver/40">// TYPICAL TIMELINES</p>
