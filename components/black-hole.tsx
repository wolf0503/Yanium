    ...
    <div className="pointer-events-none absolute inset-0 z-[5] flex items-center justify-center">
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, transparent 32%, rgba(212,175,55,0.07) 50%, rgba(180,110,10,0.04) 68%, transparent 84%)",
      ...
      >
        ...
        <div
          style={{
            ...
            height: s(28),
            background:
              "linear-gradient(to top, rgba(60,200,255,0.60) 0%, rgba(130,235,255,0.30) 50%, transparent 100%)",
        ...
        <div style={{ position: "relative", width: s(30), height: s(30), flexShrink: 0 }}>
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, transparent 38%, rgba(212,175,55,0.25) 58%, transparent 80%)",
          ...
          <div
            style={{
              ...
              boxShadow:
                "0 0 16px 3px rgba(255,225,60,0.65), 0 0 46px 8px rgba(212,175,55,0.28), inset 0 0 10px rgba(255,220,60,0.15)",
              animation: "bhPhoton 3.8s ease-in-out infinite",
            }}
          />
        ...
        <div
          style={{
            ...
            height: s(28),
            background:
              "linear-gradient(to bottom, rgba(60,200,255,0.60) 0%, rgba(130,235,255,0.30) 50%, transparent 100%)",
