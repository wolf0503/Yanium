      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <h2 className="font-display text-3xl tracking-[0.08em] md:text-5xl lg:text-6xl">
            {["NOT", "AN", "AGENCY."].map((w, i) => (
              <motion.span
                key={i}
                className="mr-[0.3em] inline-block text-silver"
            ...
            <br />
            <motion.span
              className="mr-[0.3em] inline-block text-shimmer"
              initial={{ opacity: 0, y: 28 }}
              animate={isInView ? { opacity: 1, y: 0 } : {}}
        ...
        >
          ...
          <p className="mt-6 font-serif text-base leading-relaxed text-silver/80 md:text-lg md:leading-8">
            ...
            <span className="text-silver">Yerevan, Armenia</span> — covering AI automation, web,
            mobile, backend, DevOps, QA, design, and brand identity under one roof with{" "}
            <span className="text-silver">zero handoff gaps</span>.
          </p>
          <p className="mt-6 font-serif text-base leading-relaxed text-silver/80 md:text-lg md:leading-8">
            We work with startups, established businesses, and enterprise clients. We build our own
            ventures. We take on elite freelance engagements. We form long-term technical
            partnerships.
          </p>
          ...
          <div className="mt-6 flex items-center gap-4">
            ...
            <span className="font-sans text-sm tracking-[0.2em] text-silver/50">
          ...
          {pillars.map((p, i) => (
            <MagneticCard key={p.label}>
              ...
              >
                ...
                <h4 className="mb-1 font-display text-[11px] tracking-[0.2em] text-silver/70">
                  {p.label}
                </h4>
