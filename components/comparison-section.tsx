...
const comparisonRows = [
  {
    category: "COVERAGE",
    legacy: "One discipline per agency",
    frontier: "Full-stack: web, mobile, AI, DevOps, QA, design, brand",
  },
  { category: "SPEED", legacy: "Months per milestone", frontier: "Days to production" },
  {
    category: "PRICING",
    legacy: "Hourly billing, unpredictable costs",
    frontier: "Result-based, outcome-driven",
  },
  { category: "AI CAPABILITY", legacy: "Bolted on or outsourced", frontier: "Core to every build" },
  {
    category: "WORKFLOW",
    legacy: "Manual coding, slow iteration",
    frontier: "Vibe Engineering — Human-AI hybrid",
  },
  {
    category: "TEAM STRUCTURE",
    legacy: "Large teams, slow coordination",
    frontier: "Lean specialists + AI engines",
  },
  {
    category: "AFTER LAUNCH",
    legacy: "Handoff and disappear",
    frontier: "Ongoing partnership available",
  },
  {
    category: "SCALABILITY",
    legacy: "Rebuild to scale",
    frontier: "Architected for scale from day one",
  },
  {
    category: "ENGAGEMENT TYPES",
    legacy: "Agency or freelancer",
    frontier: "Both — plus long-term partnership",
  },
];
...
function ComparisonRow({ row, index }: { row: (typeof comparisonRows)[0]; index: number }) {
  ...
  return (
    ...
    >
      <div className="pr-2">
        <span className="font-mono text-[11px] tracking-[0.2em] text-silver/65 md:text-[12px]">
          {row.category}
        </span>
      </div>
      ...
      <div className="flex items-start gap-2 px-2 md:items-center">
        ...
        <span className="text-sm font-medium leading-relaxed text-gold/90 md:text-base">
          {row.frontier}
        </span>
      </div>
    </motion.div>
      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <h2 className="font-display text-4xl tracking-[0.1em] text-silver md:text-5xl lg:text-6xl">
            <motion.span
              ...
              className="inline-block text-silver/40"
            >
              THE OLD GUARD
            </motion.span>
            <br />
          ...
          >
            Element 71 was the last rare earth to be isolated. Everyone thought the series was
            complete. It wasn&apos;t.
          </motion.p>
        </motion.div>
        ...
        >
          <div className="grid grid-cols-3 gap-2 border-b border-white/10 px-4 py-4 md:px-6">
            <span className="font-mono text-[11px] tracking-[0.3em] text-silver/45 md:text-[12px]">
              METRIC
            </span>
            <div className="flex items-center gap-2 px-2">
              <div className="h-1.5 w-1.5 shrink-0 rounded-full bg-red-400/50" />
              <span className="font-mono text-[11px] tracking-[0.2em] text-silver/45 md:text-[12px]">
                LEGACY FIRMS
              </span>
            </div>
            <div className="flex items-center gap-2 px-2">
              <div className="h-1.5 w-1.5 shrink-0 rounded-full bg-gold status-pulse" />
              <span className="font-mono text-[11px] tracking-[0.2em] text-gold md:text-[12px]">
                YANIUM
              </span>
            </div>
          </div>
