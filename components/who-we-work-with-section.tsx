    ...
    <section id="who-we-work-with" className="relative py-12 px-6 md:py-32">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          >
            Like lutetium forming stable compounds with any element it meets — Yanium adapts to your
            context without compromising the core.
          </motion.p>
        </motion.div>
        ...
        >
          <p className="mb-1 font-mono text-[11px] tracking-[0.25em] text-silver/40">
            // FREELANCE ENGAGEMENTS
          </p>
          <p className="font-serif text-base text-silver/65">
            Need elite execution on a specific build? We take select freelance projects when the
        ...
        >
          <p className="font-serif text-base text-silver/50">
